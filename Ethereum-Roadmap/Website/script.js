window.onload = function() {
  ...
  setProgressBar('merge-progress', 60); // Assuming "The Merge" is about 80% complete
  ...
  setProgressBar('splurge-progress', 25); // Assuming "The Splurge" is just starting, about 5% complete
};
