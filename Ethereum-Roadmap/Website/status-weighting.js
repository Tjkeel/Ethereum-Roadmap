...
const statusList = {
    merge: [
        ...
        ["mergeC", true, { teal: 0, green: 100, purple: 0, blue: 0, red: 0 }, {weighting: 1.1}],  // Merge! No more PoW
        ...
        ["mergeF", false, 60, {weighting: 1.3}],                                                  // Secret leader election
        ["mergeG", false, 50, {weighting: 1.4}],                                                  // Per-slot participant selection
        ["mergeH", false, 50, {weighting: 1.6}],                                                  // SSF specification
        ["mergeI", true, { teal: 0, green: 0, purple: 0, blue: 0, red: 0 }, {weighting: 1.5}],    // Implmentation
        ["mergeJ", false, 20, {weighting: 1.6}],                                                  // Single slot finality (SSF)
